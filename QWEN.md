...
- **Почта**: IMAP/SMTP через `smtp.urfu.ru`
...
- **Техническая поддержка**: `support@openedu.urfu.ru`
- **Maintainer**: `support@openedu.urfu.ru`
- **Репозиторий**: `https://github.com/urfu-online/support`
- **Мониторинг**: `https://grafana.urfu.online`
